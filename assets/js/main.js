      ...
      pages.forEach(p => {
        ...
        if (p.title === 'Follow') {
          ...
          socialIconsDiv.innerHTML = `
            ...
            <a href="mailto:wirsindchorx@gmail.com" title="E-Mail"><svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor"><path d="M0 3v18h24v-18h-24zm6.623 7.929l-4.623 5.712v-9.458l4.623 3.746zm-4.141-5.929h19.035l-9.517 7.713-9.518-7.713zm5.694 7.188l1.324 1.072c.338.274.738.411 1.138.411s.799-.137 1.138-.411l1.324-1.072 5.008 6.336h-14.94l5.008-6.336zm8.163-1.259l4.661-3.776v9.522l-4.661-5.746z"/></svg></a>
          `;
